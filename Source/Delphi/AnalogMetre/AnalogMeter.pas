...
type
  ...
  private
    ...
    fMin, fMax, fValue : Double;  //just like TSpinEdit
    ...
    fTickPrecision, fTickDigits : Longint;
    fValuePrecision, fValueDigits : Longint;
    fTickColor,
    fHighZoneColor,
    fLowZoneColor,
    fOKZoneColor : TColor;
    ...
    Procedure SetTickPrecision(v : Longint);
    Procedure SetTickDigits(v : Longint);
    Procedure SetValuePrecision(v : Longint);
    Procedure SetValueDigits(v : Longint);
    ...
    Procedure SetLowZone(percent : Double);
    Function GetLowZone : Double;
    Procedure SetHighZone(percent : Double);
    Function GetHighZone : Double;
  ...
  published
    ...
    property TickPrecision : Longint read fTickPrecision write SetTickPrecision default 7;
    //Digits when showing rounded values at ticks
    //See also TickPrecision, ValueDigits, ShowTicksScale
    property TickDigits : Longint read fTickDigits write SetTickDigits default 1;
    ...
    property ValuePrecision : Longint read fValuePrecision write SetValuePrecision default 7;
    //Digits when showing the rounded value
    //See also ValuePrecision, TickDigits, ShowTicksScale
    property ValueDigits : Longint read fValueDigits write SetValueDigits default 1;
    ...
    property LowZone : Double read GetLowZone write SetLowZone{ default 10};
    //Three zones can be defined: LowZone, HighZone and the zone inbetween(OKZone).
    ...
    property HighZone : Double read GetHighZone write SetHighZone{ default 90};
...
{-------------------------------------------------------------}
Procedure TAnalogMeter.SetTickPrecision(v : Longint);
Begin
...
{-------------------------------------------------------------}
Procedure TAnalogMeter.SetTickDigits(v : Longint);
Begin
...
{-------------------------------------------------------------}
Procedure TAnalogMeter.SetValuePrecision(v : Longint);
Begin
...
{-------------------------------------------------------------}
Procedure TAnalogMeter.SetValueDigits(v : Longint);
Begin
...
{------------------------------------------------------------------------------}
Procedure TAnalogMeter.SetMin(m : Double);
Var OldLow, OldHigh : Double;
Begin
...
{------------------------------------------------------------------------------}
Procedure TAnalogMeter.SetMax(m : Double);
Var OldLow, OldHigh : Double;
Begin
...
{------------------------------------------------------------------------------}
Procedure TAnalogMeter.SetValue(v : Double);
...
{------------------------------------------------------------------------------}
Procedure TAnalogMeter.SetLowZone(percent : Double);
Begin
...
{------------------------------------------------------------------------------}
Function TAnalogMeter.GetLowZone : Double;
Begin
  If Max = Min
    then Result := 0
...
{------------------------------------------------------------------------------}
Procedure TAnalogMeter.SetHighZone(percent : Double);
Begin
  If percent > 100 then percent := 100;
...
{------------------------------------------------------------------------------}
Function TAnalogMeter.GetHighZone : Double;
Begin
  If Max = Min
    then Result := 0
